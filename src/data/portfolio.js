...
// Three figures, not four. A fourth cell existed only because the grid had four
// columns, and "0 logins, forms or calls" was written to fill it — a statistic
// with nothing behind it reads as padding and costs credibility rather than
// adding it. Three columns, three facts that survive a "so what".
//
...
export const projects = [
  {
    ...
    asks: 'Answers from your own documents',
  ...
  },
  {
    ...
    asks: 'Automation with a human gate',
  ...
  },
  {
    ...
    asks: 'Leads answered before they cool',
  ...
  },
  {
    ...
    asks: 'Proof a prompt change helped',
  ...
  },
  {
    ...
    route: 'answer',
    family: 'LLM product engineering',
    asks: 'An assistant on your website',
    note: 'One script tag',
    order: 7,
  ...
  },
  {
    ...
    asks: 'Image generation you can repeat',
  ...
  },
  {
    ...
    asks: 'Which customers are worth the spend',
    note: 'Rejected its own headline result',
    order: 13,
    shot: 'signalroom',
