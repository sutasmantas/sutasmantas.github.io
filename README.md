...
| Route | What it is |
| --- | --- |
| `/` | Production base 43: all accepted professional interactions, a progressively warmed 13-project screenshot deck, the three client problems, and direct case/live links. |
...
Current visual checkpoint: `design-lab/BATCH_05_HANDOFF.md`. The dashboard
compares selected base 43 with three opening experiments, two ending
experiments, and five shared case-page experiments (routes 44–53).
